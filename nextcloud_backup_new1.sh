...
# Rsync the Nextcloud data directory to local machine with preserved ownership and permissions
rsync -avz --delete --owner --group --perms --times $REMOTE_USER@$REMOTE_HOST:"$REMOTE_NEXTCLOUD_DIR" "$LOCAL_BACKUP_DIR/files/"
